        ...
        protected JSONObject doInBackground(String... args) {
            ...
            try {
                if(catName.isEmpty() || catName == null){
                    url = "http://intelligent-games.com.ua/?games_api=1&get_products=1&start="+loadStart+"&end="+loadCount;
                }
                else{
                    try {
                        url = "http://intelligent-games.com.ua/?games_api=1&get_products_cat="+URLEncoder.encode(catName, "UTF-8")+"&start="+loadStart+"&end="+loadCount;
                ...
                url = "http://intelligent-games.com.ua/?games_api=1&get_products=1&start="+loadStart+"&end="+loadCount;
                Log.e("catName", "Получено исключение", exception);
            }
